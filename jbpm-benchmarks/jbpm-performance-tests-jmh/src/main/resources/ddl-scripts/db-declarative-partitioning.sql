...
CREATE TABLE audittaskimpl_000009 PARTITION OF AuditTaskImpl FOR VALUES FROM (225000) TO (250001);
...
CREATE TABLE bamtasksummary_000009 PARTITION OF BAMTaskSummary FOR VALUES FROM (225000) TO (250001);
...
CREATE TABLE nodeinstancelog_000009 PARTITION OF NodeInstanceLog FOR VALUES FROM (225000) TO (250001);
...
CREATE TABLE processinstancelog_000009 PARTITION OF ProcessInstanceLog FOR VALUES FROM (225000) TO (250001);
...
CREATE TABLE taskevent_000009 PARTITION OF TaskEvent FOR VALUES FROM (225000) TO (250001);
...
CREATE TABLE variableinstancelog_000009 PARTITION OF VariableInstanceLog FOR VALUES FROM (225000) TO (250001);
